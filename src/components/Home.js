  ...
  return (
    <div className="mt-5">
      ...
      <p className="text-center">
        ...
        the course.
        <br /> I'm open to feedback and suggestions, so please feel free to
        reach out in our WhatsApp group, or you can email me at <strong>dllopis16@gmail.com</strong>
      </p>
    </div>
  );
};